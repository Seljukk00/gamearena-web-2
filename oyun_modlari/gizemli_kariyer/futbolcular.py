...
ALL_PLAYERS = [
    ...
    {"name": "Keylor Navas", "career": ["Albacete", "Levante", "Real Madrid", "PSG"], "difficulty": "orta"},
    ...
    {"name": "Morientes", "career": ["Albacete", "Real Zaragoza", "Real Madrid", "Monaco", "Liverpool", "Valencia", "Marseille"], "difficulty": "zor"},
